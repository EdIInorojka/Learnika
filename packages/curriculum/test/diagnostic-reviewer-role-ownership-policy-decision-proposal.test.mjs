...
test("Slice 3 guard admits the exact cumulative Slice 5 continuation separately", () => {
  ...
  assert.deepEqual(
    validateReviewerRoleOwnershipDecisionProposalWorktreeScope(approvedWave6Slice5ChangedPaths, {
      env: {},
    }),
    approvedWave6Slice5ChangedPaths,
  );
...
test("Slice 3 guard admits the exact cumulative Slice 6 continuation separately", () => {
  ...
  assert.deepEqual(
    validateReviewerRoleOwnershipDecisionProposalWorktreeScope(approvedWave6Slice6ChangedPaths, {
      env: {},
    }),
    approvedWave6Slice6ChangedPaths,
  );
