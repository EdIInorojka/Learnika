...
test("Slice 3 worktree guard admits the cumulative exact Slice 12 scope", () => {
  assert.deepEqual(
...
test("Slice 3 guard admits only the exact five Slice 7 static files", () => {
  const approvedPaths = [
...
test("Slice 3 guard admits only the exact five Slice 10 static files", () => {
  const approvedPaths = [
...
test("Slice 3 guard admits only the exact five Slice 12 static files", () => {
  const approvedPaths = [
...
test("Slice 3 guard admits only the exact five Slice 13 static files", () => {
  const approvedPaths = [
