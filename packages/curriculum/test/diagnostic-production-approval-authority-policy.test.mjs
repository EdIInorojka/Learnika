...
test("Slice 10 worktree guard permits only the exact 38 Slice 11 implementation paths", () => {
  assert.equal(expectedChangedPaths.length, 38);
  assert.equal(new Set(expectedChangedPaths).size, 38);
  assert.deepEqual(
