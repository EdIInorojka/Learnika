...
test("Slice 5 worktree guard permits only the exact 40 Slice 12 implementation paths", () => {
  assert.deepEqual(
    validateReviewerRoleOwnershipPolicyChangedPaths(approvedSlice12ChangedPaths),
