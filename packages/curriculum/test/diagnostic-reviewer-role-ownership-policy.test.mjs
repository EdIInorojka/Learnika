...
test("Slice 5 worktree guard permits only the exact 38 Slice 11 implementation paths", () => {
  assert.deepEqual(
    validateReviewerRoleOwnershipPolicyChangedPaths(approvedSlice11ChangedPaths),
