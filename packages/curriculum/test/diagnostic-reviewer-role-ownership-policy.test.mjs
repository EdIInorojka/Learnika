...
test("Slice 5 worktree guard permits only the exact 36 Slice 10 implementation paths", () => {
  assert.deepEqual(
    validateReviewerRoleOwnershipPolicyChangedPaths(approvedSlice10ChangedPaths),
