...
test("Slice 8 worktree guard permits only the exact 40 Slice 12 implementation paths", () => {
  assert.deepEqual(
    validateAuditIdentityPolicyChangedPaths(approvedSlice12ChangedPaths),
