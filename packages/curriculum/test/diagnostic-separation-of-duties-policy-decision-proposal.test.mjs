...
import {
  ...
  validateSeparationOfDutiesDecisionProposalSlice7ChangedPaths,
  validateSeparationOfDutiesDecisionProposalSlice8ChangedPaths,
...
const approvedWave6Slice5ChangedPaths = [
  ...approvedWave6Slice4ChangedPaths.filter((path) => !slice4PrimaryOnlyPaths.has(path)),
...
test("Slice 4 guard admits only the exact cumulative Slice 5 continuation", () => {
  assert.equal(approvedWave6Slice5ChangedPaths.length, 42);
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalSlice5ChangedPaths(approvedWave6Slice5ChangedPaths),
    approvedWave6Slice5ChangedPaths,
  );
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalWorktreeScope(approvedWave6Slice5ChangedPaths, {
      env: { GITHUB_ACTIONS: "false" },
    }),
    approvedWave6Slice5ChangedPaths,
  );
...
test("Slice 4 guard admits only the exact cumulative Slice 7 continuation", () => {
  assert.equal(approvedWave6Slice7ChangedPaths.length, 46);
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalSlice7ChangedPaths(approvedWave6Slice7ChangedPaths),
    approvedWave6Slice7ChangedPaths,
  );
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalWorktreeScope(approvedWave6Slice7ChangedPaths, {
      env: { GITHUB_ACTIONS: "false" },
    }),
    approvedWave6Slice7ChangedPaths,
  );
...
test("Slice 4 guard admits only the exact cumulative Slice 8 continuation", () => {
  assert.equal(approvedWave6Slice8ChangedPaths.length, 48);
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalSlice8ChangedPaths(approvedWave6Slice8ChangedPaths),
    approvedWave6Slice8ChangedPaths,
  );
  assert.deepEqual(
    validateSeparationOfDutiesDecisionProposalWorktreeScope(approvedWave6Slice8ChangedPaths, {
      env: { GITHUB_ACTIONS: "false" },
    }),
    approvedWave6Slice8ChangedPaths,
  );
