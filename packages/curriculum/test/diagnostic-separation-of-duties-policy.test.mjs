...
test("Slice 6 worktree guard permits only the exact 32 Slice 8 implementation paths", () => {
  assert.deepEqual(
    validateSeparationOfDutiesPolicyChangedPaths(approvedSlice8ChangedPaths),
