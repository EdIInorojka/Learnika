...
test("Slice 6 worktree guard permits only the exact 34 Slice 9 implementation paths", () => {
  assert.deepEqual(
    validateSeparationOfDutiesPolicyChangedPaths(approvedSlice9ChangedPaths),
